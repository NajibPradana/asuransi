...
return new class extends SettingsMigration
{
    ...
    {
        $this->migrator->add('mail.from_address', 'mailer@filamentstarterkit.com');
        $this->migrator->add('mail.from_name', 'Filament Starter Kit');
        $this->migrator->add('mail.reply_to_address', 'support@filamentstarterkit.com');
        $this->migrator->add('mail.reply_to_name', 'Filament Starter Kit Support');
        ...
        $this->migrator->add('mail.footer_text', '© ' . date('Y') . ' Filament Starter Kit. All rights reserved.');
