                                                ...
                                                <li>
                                                    <a href="{{ $post->getUrl() }}"  class="flex items-center gap-x-[10px] hover:text-primary-600" wire:click="trackView('{{ $post->id }}')">
                                                        @if($post->author && $post->author->profile_photo_path)
                                                            <img src="{{ Storage::url($post->author->profile_photo_path) }}" alt="{{ $post->author->fullname }}" width="45" height="45" class="rounded-[50%]" />
                                                        @else
                                                            <img src="https://placehold.co/45x45?text={{ substr($post->author->fullname ?? 'A', 0, 1) }}" alt="{{ $post->author->fullname ?? 'Author' }}" width="45" height="45" class="rounded-[50%]" />
                                                        @endif
