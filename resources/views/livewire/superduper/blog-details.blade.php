<div>
    ...
    <x-superduper.components.breadcrumb
        ...
        :items="[
            ...
            ['label' => $post?->category->name ?? 'Uncategorized', 'url' => route('blog', ['category' => $post?->category->id ?? null])],
            ['label' => $post->title]
        ]"
    />
                            ...
                            <article class="overflow-hidden bg-white jos">
                                ...
                                <div class="px-[30px]">
                                    ...
                                    <ul class="mb-[30px] flex flex-wrap items-center gap-4 text-base font-semibold sm:gap-6">
                                            ...
                                            <div class="flex items-center gap-x-[10px]">
                                                @if($post->author && $post->author->profile_photo_path)
                                                    <img src="{{ Storage::url($post->author->profile_photo_path) }}"
                                                         ...
                                                         class="rounded-[50%]" />
                                                @else
                                                    <img src="https://placehold.co/45x45?text={{ substr($post->author->fullname ?? 'A', 0, 1) }}"
                                        ...
                                        {{-- Category --}}
                                        <li>
                                            <a href="{{ route('blog', ['category' => $post?->category->id ?? null]) }}"
                                        ...
                                        <div class="flex-shrink-0 w-20 h-20">
                                            ...
                                            @else
                                                <div class="flex items-center justify-center w-full h-full text-2xl text-white rounded-full bg-color-blue">
                                                    {{ substr($post->author->fullname ?? 'A', 0, 1) }}
                                                </div>
                                            @endif
                                        </div>
                                        <div>
                                            <h3 class="mb-2 text-xl font-semibold">{{ $post->author->fullname }}</h3>
