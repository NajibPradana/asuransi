<div
    x-data="{
        ...
        templateTheme: @js($attributes->get('theme-name', 'default')),
    ...
    x-init="
        ...
        $watch('$store.form.data.template_theme', value => { templateTheme = value || 'default' });
...
>
    <div class="p-4 overflow-hidden border border-gray-200 rounded-lg bg-gray-50">
            ...
            <div class="mb-0">
                <template x-if="logoPath">
                    <div class="flex justify-center">
                        <img x-bind:src="logoPath" alt="Logo" class="h-8 max-w-[180px]" />
                    </div>
                </template>
                <template x-if="!logoPath">
        ...
        <div class="p-6 bg-white border-gray-200 border-x">
            ...
            <p class="mb-2">
                Email theme: <strong x-text="templateTheme.charAt(0).toUpperCase() + templateTheme.slice(1)"></strong>
            </p>
