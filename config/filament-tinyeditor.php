...
return [
    ...
    'profiles' => [
        ...
        'custom' => [
            'plugins' => 'table wordcount code lists pagebreak',
            'toolbar' => 'undo redo | bold italic underline strikethrough | alignjustify alignleft aligncenter alignright | numlist bullist | table tablecellvalign | pagebreak | code',
            'upload_directory' => null,
            'custom_configs' => [
                'image_caption' => true,
                'table_use_colgroups' => false,
                'pagebreak_separator' => '<div class="page-break"><!-- my page break --></div>'
            ]
        ],
    ],
