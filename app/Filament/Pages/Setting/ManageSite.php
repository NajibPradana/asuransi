...
class ManageSite extends SettingsPage
{
    ...
    {
        // Ensure featured_upp_ids is an array
        if (!isset($data['featured_upp_ids']) || !is_array($data['featured_upp_ids'])) {
            $data['featured_upp_ids'] = [];
        }

        // Ensure featured_venue_ids is an array
        if (!isset($data['featured_venue_ids']) || !is_array($data['featured_venue_ids'])) {
            $data['featured_venue_ids'] = [];
        }
                ...
                Forms\Components\Section::make('Basic Information')
                    ...
                    ->schema([
                        ...
                        Forms\Components\FileUpload::make('logo')
                            ...
                            ->helperText('Recommended size: 400x100 pixels'),
