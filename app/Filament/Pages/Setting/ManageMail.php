...
class ManageMail extends SettingsPage
{
    ...
    protected static ?string $navigationIcon = 'fluentui-mail-settings-20-o';
                                ...
                                Forms\Components\Section::make('Email Appearance')
                                    ...
                                    ->schema([
                                        ...
                                        FileUpload::make('logo_path')
                                            ...
                                            ->columnSpan(2)
                                            ->helperText('Upload a logo for your emails. Recommended size: 400x100 pixels'),
                                    ...
                                    ->schema([
                                        Forms\Components\View::make('filament.components.email-template-preview')
                                            ->viewData(function (callable $get) {
                                                $logo_path = 'https://placehold.co/400x100.jpeg?text=Email%20Logo';
                                                ...
                                                // $logo_path = empty(app(MailSettings::class)->logo_path) ? 'https://placehold.co/400x100.jpeg?text=Email%20Logo'
                                                //     : Storage::url(app(MailSettings::class)->logo_path);
    ...
    public function sendTestMail(?MailSettings $settings = null)
    {
        ...
        try {
            ...
            $mailData = [
                ...
                'theme' => [
                    // 'logo_path' => $data['logo_path'] ?? 'https://placehold.co/400x100.jpeg?text=No%20Image',
            ...
            $mailTemplate = new TestMail($mailData);
